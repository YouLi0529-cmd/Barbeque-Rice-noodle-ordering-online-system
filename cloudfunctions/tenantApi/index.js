...
async function handleAction(action, payload) {
  ...
  if (action === 'admin.table.retryFailedKitchenItems') return adminRetryFailedKitchenItems(payload)
  ...
  if (action === 'admin.order.retryFailedKitchenItems') return adminRetryFailedKitchenItems(payload)
